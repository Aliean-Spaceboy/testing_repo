...
// I also need to remove the old .heatmap classes near line 401
...
const startIndex = code.indexOf('/* CLOUD SYNC */');
if (startIndex !== -1) {
    code = code.substring(0, startIndex) + replacement + code.substring(startIndex + 16);
    fs.writeFileSync('style.css', code);
    console.log("Replaced Calendar block.");
} else {
